...
public class BpjsService {
	...
	public Object tambahAntrian(HttpHeaders header, ParamTambahAntrian tambahAntrian) {
		try {

			RestTemplate restTemplate = new RestTemplate();

			HttpEntity<ParamTambahAntrian> entity = new HttpEntity<>(tambahAntrian, header);
			return restTemplate.exchange(url.getUrl().toString() + "/arsws/rest/v2/antrean/add", HttpMethod.POST,
					entity, Object.class);
		} catch (Exception e) {
	...
	public Object updateWaktuAntrian(HttpHeaders header, ParamUpdateWaktuAntrean updateWaktuAntrian) {
		...
		try {
			...
			HttpEntity<ParamUpdateWaktuAntrean> entity = new HttpEntity<ParamUpdateWaktuAntrean>(updateWaktuAntrian,
					header);
			return restTemplate.exchange(url.getUrl().toString() + "/arsws/rest/v2/antrean/updatewaktu",
	...
	public Object batalAntrean(HttpHeaders header, ParamBatalAntrean batalAntrian) {
		...
		try {
			...
			return restTemplate.exchange(url.getUrl().toString() + "/arsws/rest/v2/antrean/batal", HttpMethod.POST,
					entity, Object.class);
		} catch (Exception e) {
			// TODO: handle exception
	...
	public Object updateJadwalDokter(HttpHeaders header, ParamUpdateJadwalDokter updateJadwalDokter) {
		try {
			...
			HttpEntity<ParamUpdateJadwalDokter> entity = new HttpEntity<ParamUpdateJadwalDokter>(updateJadwalDokter,
					header);

			return restTemplate.exchange(url.getUrl().toString() + "/arsws/rest/v1/jadwaldokter/updatejadwaldokter",
					HttpMethod.POST, entity, Object.class);
		} catch (Exception e) {
			// TODO: handle exception
			return e;
	...
	public Object jadwalDokter(HttpHeaders header, String kodePoli, LocalDate tanggal) {
		try {
			...
			return restTemplate.exchange(url.getUrl().toString() + "/arsws/rest/v1/jadwaldokter/kodepoli/" + kodePoli
					+ "/tanggal/" + tanggal, HttpMethod.GET, entity, Object.class);
		} catch (Exception e) {
			// TODO: handle exception
			return e;
		}
	...
	public Object getListTask(HttpHeaders header, ParamKodeBooking kodeBooking) {
		try {
			...
			// return entity;
			return restTemplate.exchange(url.getUrl().toString() + "/arsws/rest/v2/antrean/getlisttask",
					HttpMethod.POST, entity, Object.class);
		} catch (Exception e) {
			// TODO: handle exception
			return e;

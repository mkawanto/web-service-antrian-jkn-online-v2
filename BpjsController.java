...
public class BpjsController {
	...
	public String tambahAntrian(
			@Valid @RequestBody ParamTambahAntrian tambahAntrian, 
			HttpServletRequest httpServlet ) {
		
		HttpHeaders extractHttp = (HttpHeaders) extractRequestService.extracthHttp(httpServlet);
		return (String) service.tambahAntrian(extractHttp, tambahAntrian);
	}
	...
	@Validated
	public Object updateWaktuAntrian(
			@Valid @RequestBody ParamUpdateWaktuAntrean waktuAntrean,
			HttpServletRequest httpServlet) {
	...
	@Validated
	public Object batalAntrian(
			@Valid
			@RequestBody ParamBatalAntrean batalAntrean,
			HttpServletRequest httpServlet) {
	...
	@Validated
	public Object updateJadwalDokter(
			@Valid @RequestBody ParamUpdateJadwalDokter updateJadwalDokter,
			HttpServletRequest httpServlet ) {
	...
	public Object getListTask(
			@RequestBody ParamKodeBooking kodeBooking,
			HttpServletRequest httpServlet) {
